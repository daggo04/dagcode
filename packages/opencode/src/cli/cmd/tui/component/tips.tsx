...
const TIPS = [
  ...
  "DagCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "DagCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "DagCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent DagCode from reading sensitive files",
